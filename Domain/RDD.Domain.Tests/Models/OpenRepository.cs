...
namespace RDD.Domain.Tests.Models
{
    public class OpenRepository<TEntity> : Repository<TEntity>
        where TEntity : class
    {
        public OpenRepository(IStorageService storageService, IRightExpressionsHelper rightsService, QueryRequest queryRequest)
        : base(storageService, rightsService, queryRequest) { }
